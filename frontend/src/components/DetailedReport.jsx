  ...
  return (
    <div className="detailed-report-overlay">
      ...
      <div className="detailed-report-body">
        ...
        {/* ================= PAGE 1: COVER PAGE ================= */}
        <div className="wp-page" style={{ border: '1px solid var(--border)', position: 'relative' }}>
          {/* Top-right wave vector matching template */}
          <div style={{ position: 'absolute', right: 0, top: 0, width: '300px', height: '180px', overflow: 'hidden', zIndex: 0 }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, padding: '14mm 16mm 0' }}>
            <div className="brand">
        ...
        {/* ================= PAGE 12: THANK YOU ================= */}
        <div className="wp-page" style={{ display: 'flex', flexDirection: 'column', position: 'relative' }}>
          {/* Top-right wave vector matching template */}
          <div style={{ position: 'absolute', right: 0, top: 0, width: '300px', height: '180px', overflow: 'hidden', zIndex: 0 }}>
            <div style={{ transform: 'scale(0.55) rotate(4deg)', transformOrigin: 'top right', width: '760px', height: '480px' }}>
              <svg width="760" height="480" viewBox="0 0 760 480">
          ...
          <div style={{ position: 'relative', zIndex: 1, padding: '12mm 16mm 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <img src={LOGO_BASE64} alt="Infopace" style={{ height: '56px' }} />
            <div className="wp-mono" style={{ fontSize: '10.3px', color: '#94a3b8' }}>12 / 12</div>
          </div>
          <div style={{ position: 'relative', zIndex: 1, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', padding: '6mm 16mm 0' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, padding: '0 16mm 14mm' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '9.5px', color: '#94a3b8', letterSpacing: '.02em' }}>
              <div>©2026 Infopace Management Pvt. Ltd. All Rights Reserved.</div>
              <div>AI-Evaluated Report</div>
            </div>
